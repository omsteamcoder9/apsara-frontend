...
export default function OrderSuccessPage() {
    ...
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/"
                className="bg-orange-500 text-white px-6 py-3 rounded-xl hover:bg-orange-600 hover:shadow-orange-500/30 transition-all duration-200 font-medium text-center shadow-lg"
              >
                Return to Home
              </Link>
              <Link 
                href="/cart"
                className="border-2 border-orange-500 text-orange-600 px-6 py-3 rounded-xl hover:bg-orange-500 hover:text-white hover:shadow-orange-500/30 transition-all duration-200 font-medium text-center"
              >
                Back to Cart
              </Link>
            </div>
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex items-center justify-center py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-sm border border-stone-200 p-8 hover:shadow-md transition-shadow duration-200">
          ...
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Order Placed Successfully!</h1>
          ...
          <div className="bg-stone-50 rounded-xl p-4 mb-6 border border-stone-200">
            <p className="text-stone-600 text-sm">
              Order ID: <span className="font-mono font-semibold text-orange-600">#{orderId}</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/products"
              className="bg-orange-500 text-white px-6 py-3 rounded-xl hover:bg-orange-600 hover:shadow-orange-500/30 transition-all duration-200 font-medium text-center shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Continue Shopping
            </Link>
            <Link 
